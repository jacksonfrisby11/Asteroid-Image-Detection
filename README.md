...
A Decision Tree / Random Forest model trained on metadata

The project demonstrates data cleaning, augmentation, model training, evaluation, and comparison between image-based and metadata-based learning.
